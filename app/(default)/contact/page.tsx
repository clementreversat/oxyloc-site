export const metadata = {
    ...
    description: "Contactez Oxyloc pour la gestion locative à Paris et Versailles",
};
                ...
                <div className="space-y-8">
                    ...
                    <div className="text-center space-y-2">
                        <p className="text-lg text-[var(--muted-foreground)]">
                            <strong className="text-[#024053]">Oxyloc</strong> est une marque déposée de la société <strong>Immoxygen Gestion</strong>
                        </p>
                    </div>
