...
// Desktop: Flip card with clearer folded-corner indicator
...
function FlipCard({
  ...
  return (
    <>
        ...
        >
          ...
          >
            <div className="p-5 bg-[#024053] text-white">
              <p className="text-sm leading-relaxed">{formatBackText()}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* DESKTOP: Flip Card */}
      <div
        className="hidden md:block relative h-72 cursor-pointer perspective-1000 transition-transform duration-300 hover:-translate-y-1 hover:shadow-xl"
...
<div className="absolute bottom-0 right-0 pointer-events-none">
  <div className="relative w-12 h-12">
    ...
    <div
      ...
      style={{
        clipPath: "polygon(100% 0, 0 100%, 100% 100%)",
        background: "linear-gradient(135deg, rgba(0,0,0,0.20), transparent 55%)",
      }}
    />
    {/* thin edge line (subtle) */}
    <div
      className="absolute bottom-0 right-0 w-12 h-12"
      style={{
        clipPath: "polygon(100% 0, 0 100%, 100% 100%)",
  ...
  return (
    <main className="bg-white">
      ...
      <section className="pt-8 pb-16 md:pt-12 md:pb-20 bg-white">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <h1 className="text-xl md:text-2xl lg:text-3xl font-semibold text-[#024053] leading-snug mb-6 max-w-5xl">
            Nous sommes des investisseurs qui avons pensé notre offre de services
            à partir de nos constats terrain et de nos expériences
          ...
          <p className="text-base md:text-lg text-[var(--muted-foreground)] mb-6 leading-relaxed max-w-4xl">
            Parce que vous n&apos;avez peut-être pas beaucoup de temps pour découvrir
            notre proposition de valeur, nous nous sommes dit qu&apos;une courte vidéo
            de présentation pourrait vous être utile…
          </p>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-[#E0F2FE] to-[#F0F9FF]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <h2 className="text-2xl md:text-3xl font-semibold text-[#024053] text-center mb-4">
            Nous croyons avant tout à la Proximité, à la Haute Qualité &amp; au Long
            Terme
          </h2>
          <p className="text-center text-[var(--muted-foreground)] mb-12 max-w-5xl mx-auto">
            Parce que nous sommes d&apos;abord votre conseiller, nous mettons en œuvre
            un accompagnement protecteur de vos intérêts afin de vous simplifier au
            maximum l&apos;administratif, vous libérer d&apos;une charge mentale et vous
            permettre de vous concentrer sur l&apos;essentiel.
          </p>
          ...
          <div className="space-y-4 md:space-y-0 md:grid md:grid-cols-2 lg:grid-cols-5 md:gap-4">
            ...
            <FlipCard
              ...
              backText="Nous offrons une expérience de bout en bout sereine en vous donnant accès à notre écosystème de partenaires comptables et d’assurance, et en vous rappelant régulièrement vos échéances déclaratives et fiscales"
            />
            <FlipCard
              image="notre-approche1_4"
              caption="Le temps est un capital que nous faisons fructifier ensemble"
              backText="Afin que nos échanges restent agiles et efficaces, nous avons choisi d&apos;investir dans des outils et des méthodes qui optimisent et simplifient les interactions avec nos propriétaires (et vos locataires)"
            />
            <FlipCard
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <p className="text-center text-[var(--muted-foreground)] mb-12 max-w-4xl mx-auto">
            Parce que nous sommes en recherche constante de simplification de nos
            interactions avec nos propriétaires et locataires.
          </p>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-[#E0F2FE] to-[#F0F9FF]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <h2 className="text-2xl md:text-3xl font-semibold text-[#024053] text-center mb-4">
            Notre engagement à vos côtés optimise votre temps et la rentabilité de
            vos actifs
          </h2>
          <p className="text-center text-[var(--muted-foreground)] mb-12 max-w-4xl mx-auto">
            Parce que la qualité d&apos;un projet immobilier dépend de la fiabilité de
            chaque pierre qui le compose, chaque poste de revenus et chaque poste
            de charge doit être optimisé.
          </p>
