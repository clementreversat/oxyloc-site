  ...
  const articles = [
    {
      ...
      excerpt:
        "Découvrez les points essentiels à vérifier avant de confier votre bien : solvabilité, garanties, et compatibilité avec le logement.",
    ...
    },
    {
      ...
      excerpt:
        "Analyse des tendances : loyers, demande locative et perspectives pour les propriétaires bailleurs dans la capitale.",
    ...
    },
    {
      ...
      excerpt:
        "État des lieux, diagnostics, DPE... Faites le point sur les nouvelles réglementations à respecter cette année.",
      date: "5 janvier 2025",
    ...
    },
    {
      ...
      excerpt:
        "Nos experts partagent leurs meilleures pratiques pour maximiser vos revenus locatifs tout en limitant les charges.",
    ...
    },
    {
      ...
      excerpt:
        "Pourquoi confier votre bien à un professionnel ? Avantages, coûts et processus expliqués simplement.",
    ...
    },
    {
      ...
      excerpt:
        "Tout savoir sur cette formule flexible de location de 1 à 10 mois, idéale pour certains profils de locataires.",
