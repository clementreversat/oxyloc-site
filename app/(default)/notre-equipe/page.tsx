...
export default function NotreEquipePage() {
  const team = [
    {
      name: "Thibault",
      linkedin: "https://www.linkedin.com/in/thibault-d-halluin-1b648710b/",
    },
    { name: "Marc", linkedin: "https://www.linkedin.com/in/marchoudet/" },
    {
      name: "Sébastien",
      linkedin: "https://www.linkedin.com/in/s%C3%A9bastien-henot-82766a10/",
    },
  ];
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-base text-[var(--muted-foreground)] leading-relaxed">
                  Nous sommes nous-mêmes investisseurs. Nous sommes convaincus
                  qu'un investissement locatif réussi repose sur trois piliers :
                  optimiser les revenus, maîtriser les dépenses et prendre soin
              ...
              <div>
                ...
                <p className="text-base text-[var(--muted-foreground)] leading-relaxed">
                  C'est le volume que nous avons géré au cours de nos
                  expériences respectives. Une équipe soudée et expérimentée,
                  avec un seul engagement : trouver les meilleures solutions
              ...
              <div>
                ...
                <p className="text-base text-[var(--muted-foreground)] leading-relaxed">
                  Qualité de service et amélioration continue sont devenues des
                  réflexes. Nous venons de grands groupes où la satisfaction
                  client est au cœur de l'activité.
                </p>
              </div>
            </div>
          </div>
