    ...
    <main className="bg-white">
      <section className="relative py-20 md:py-28">
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/vos-appreciations/Image_MicroVintage.jpg"
            alt="Background"
            fill
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-4 sm:px-6 text-center">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-semibold text-gray-900 leading-tight mb-12">
            Parce que c'est plus impactant,{" "}
            <span className="text-cyan-500">
              nous préférons laisser nos clients parler de nous…
            </span>
          </h1>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              >
                <p className="text-gray-900 text-base leading-relaxed italic mb-4">
                  "{item.quote}"
                </p>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <p className="text-center text-gray-600 mb-12">
            Bientôt disponible : découvrez les témoignages de nos clients en
            vidéo
          </p>
            ...
            <div className="flex items-center justify-center gap-4 text-gray-400">
              ...
              <div className="text-left">
                <p className="text-sm font-medium text-gray-600">
                  Carrousel de vidéos testimonials
                </p>
